...
def decode(save_path, save_file, model_dir, split, batch_size,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_file', required=True, help='path to store/eval')
    ...
    decode(args.path, args.save_file, args.model_dir,
