...
STORIES_DIR = "../Data/Datasets/ontonotes/stories/data/files/data/english/annotations/nw/wsj/"
PAIR_SENT_DIR = "../Data/Datasets/ontonotes_wsj/pair_sent_matched/All"
JSON_DIR = "../Data/Datasets/ontonotes_wsj/json_dir/All"

if not os.path.exists("../Data/Datasets/ontonotes_wsj/"):
    os.mkdir("../Data/Datasets/ontonotes_wsj/")

if not os.path.exists("../Data/Datasets/ontonotes_wsj/pair_sent_matched"):
    os.mkdir("../Data/Datasets/ontonotes_wsj/pair_sent_matched")

if not os.path.exists("../Data/Datasets/ontonotes_wsj/json_dir"):
    os.mkdir("../Data/Datasets/ontonotes_wsj/json_dir")
